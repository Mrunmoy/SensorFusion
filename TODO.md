...
- [ ] **ADXL345 middleware interface** — only driver without `IAccelGyroSensor` impl
- [ ] **Environmental sensor interfaces** — define `IHumiditySensor`, `IVocSensor` (or similar) for SHT40/SGP40 so SensorHub can manage them
